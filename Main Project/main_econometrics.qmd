...
full_formula <- reformulate(c(modeling_vars, "post_covid","post_covid*log_officers",
                             "post_covid*pct_highschool_or_greater", "post_covid*per_capita_migration", "post_covid*log_per_capita_alc_taxes", 
                             "post_covid*top_cities",  "post_covid*reservations"), 
...
      This model explains 64% of the variance in crime rates and having an RMSE of about half of the standard deviation in crime rates. Heteroskedastic robust errors are used to compensate for some of the variance issues, particularly with medium level crime rates seen in the residuals vs fits plot.
