...
      In this paper a 1998 study examining the sociological factors which impact crime across Minnesota counties is revisited. This study's original parameters and data are analyzed from not only 1998 to the present but across two 5 year periods before and after COVID. A clear spike in crime during COVID has been noted in previous literature and an examination of changes in traditional sociological predictors across COVID as well as from 1998 to present day is conducted. The current study uses the classic analysis techniques used in the original study such as correlation analysis as well as OLS regression combined with LASSO regression and structural break tests to determine how the relationships between crime and its determinants changed over time, particularly in response to the COVID-19 pandemic?\
