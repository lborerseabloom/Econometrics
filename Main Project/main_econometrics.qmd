...
      In this paper a 1998 study examining the sociological factors which impact crime across Minnesota counties is revisited. This studies original parameters and data are analyzed from not only 1998 to the present but across two 5 year periods before and after COVID. A clear spike in crime during COVID has been noted in previous literature and an examination of changes in traditional sociological predictors across COVID as well as from 1998 to present day is conducted. This study uses the classic analysis techniques used in the original study such as correlation analysis as well as OLS regression combined with LASSO regression and structural break tests to determine how the relationships between crime and its determinants changed over time, particularly in response to the COVID-19 pandemic?\
      Initially as observed in previous literature a clear shift in crime during crime is noted during COVID. Additionally, many significant correlations between classic predictors and crime as well as shifts in their relationships over covid are seen in graphs. Once these relationships are modeled with OLS however, all of the interaction and effect of COVID on crime becomes insignificant and just a few of the original predictors are left with any predictive power. These variables do showcase some key changes from the original study and a shift in relationships from 1998. One of the key findings being the added indicator variable for if a county contains a reservation was added and it's main effect as well as interaction with net migration into a county were found to be significant and meaningful through the process. Additionally other classic predictors of crime also remained significant such as median household income and population density.\
      These findings showcase a lack of key changes in crime across Minnesotan counties during COVID, but also represent a shift in crimes predictors from the original 1998 study. The addition of the reservations indicator variable and it's interaction also add to the previous study's findings on factors impacting crime.
