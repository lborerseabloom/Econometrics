...
#     better explain alcohol imputation method
#     explain outline and centroids better on mn map
#     write out formula for models being fit
#     statistical test for normality in resids vs fits
#     explain hypotheses being tested in cumsum and chow test 
#     formally define LASSO regression with more depth
-->
```
...
=
\hat{\beta}_0
+ \hat{\beta}_1\,{median\_household\_income}_i
+ \hat{\beta}_2\,\log({persons\_per\_m2}_i)
+ \hat{\beta}_3\,{reservations}_i
+ \hat{\beta}_4\,\bigl({reservations}_i \times {per\_capita\_migration}_i\bigr)
+ \hat{\beta}_5\,\log({pct\_non\_white}_i)
+ \hat{\beta}_6\,\log(per\_capita\_alc_taxes}_i)
+ \varepsilon_i
$$
...
      This interpretation is again supported by structural break tests below, which fail to detect meaningful parameter shifts over time at again highly insignificant levels. \
