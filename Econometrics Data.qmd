...
```{r plot_census_data_differences}
#| warning: False
  
plot_census_data <- function(data, year_to_plot){
...
plot_census_data(yearly_large_county_data, 2005)
plot_census_data(yearly_large_county_data, 2009)
plot_census_data(yearly_large_county_data, 2014)
plot_census_data(yearly_large_county_data, 2019)
plot_census_data(yearly_large_county_data, 2023)
plot_census_data(yearly_large_county_data, 2024)
