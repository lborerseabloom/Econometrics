...
## Model Evaluations
- general overview and comments on models performance, assumptions, and highlights
- differences from original study

## Model Evaluations (2)
- differences between my models
- what this all tells us

# Conclusions

## Issues and Future goals
- hope to fit a lasso regression model to better test what variables should be included in my models
- problems with the data: issues with fbi and census data, not exact same data as used by the original paper
