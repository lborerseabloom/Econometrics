...
modeling_vars <- c("officers", "median_household_income_acs5", "pct_lessthan_5kincome", 
  "pct_highschool_or_greater", "pct_children_missing_parents", "msp_main_counties",
  "pct_non_white", "Binge.drinking.prevalence", "pct_young_males", 
  "persons_per_household", "log(persons_per_m2)"
)
...
walk(modeling_vars, function(var) {
  ggplot(acs_5_yearly_data, aes_string(x = var, y = "crime_rate")) +
...
```{r differenced_data}
# dont see too muc hwhen taking the difference and comparing to explanatory census variables
