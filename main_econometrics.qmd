...
cor(
  acs_1_yearly_data |> 
    ...
    select(homicide_rate, crime_rate, periods, post_covid, msp_main_counties, officers, median_household_income, pct_lessthan_5kincome, pct_highschool_or_greater, pct_children_missing_parents, pct_non_white, Binge.drinking.prevalence),
