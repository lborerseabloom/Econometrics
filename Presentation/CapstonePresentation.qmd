...
kable(summary_stats, format = "html",
  ...
  kable_styling("striped", font_size = font)
```
:::
::::
...
kable(crime_correlation, format = "html", caption = "Significance of correlation with crime rates")|>
  kable_styling("striped", font_size = font)  
```
:::
::::
...
model_metrics <- tibble(
  Model    = c("Full Model", "Difference Model"),
  R2       = c(
